...
{	
	...
	public static void main(String[] args)
	{
		...
		try{
			...
			f = new File("C:/Users/Santosh/Desktop/Employee Management System/EmployeeDetails.txt");
			if(f.exists())
			{
		...
		do
		{
			...
			case 2: System.out.print("Enter the Employee ID to search :\t");
					id = sc.nextInt();
					int i=0;
					for(Employee e: al)
					{
			...
			case 3: System.out.print("\nEnter the Employee ID to EDIT the details\t");
					...
					for(Employee e: al)
					{
						...
						do{
							...
							case 2: System.out.print("Enter new Employee Name:\t");
									sc.nextLine();
									e.name =sc.nextLine();
									System.out.println(e+"\n");
									break;
									
							case 3: System.out.print("Enter new Employee Salary:\t");
									e.salary =sc.nextFloat();
									System.out.println(e+"\n");
									break;
									
							case 4: System.out.print("Enter new Employee Contact No. :\t");
									e.contact_no =sc.nextLong();
									System.out.println(e+"\n");
									break;
									
							case 5: System.out.print("Enter new Employee Email-ID :\t");
									e.email_id =sc.next();
									System.out.println(e+"\n");
									break;
